...
<!-- component -->
      ...
      <div class="flex flex-wrap justify-center gap-2 p-4">
        ...
        <a href="https://www.linkedin.com/in/patrick-mugambi-172b171a0/"><button class="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
        ...
        <a href="https://github.com/Mugambi645"><button class="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
        ...
        <a href = "mailto: mugambi645@gmail.com"><button class="bg-red-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
